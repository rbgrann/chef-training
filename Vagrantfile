...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ptshrdn-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tv"
  #   chef.validation_client_name = "tv-validator"
  #   chef.validation_key_path = ".chef/tv-validator.pem"
  # end
end
